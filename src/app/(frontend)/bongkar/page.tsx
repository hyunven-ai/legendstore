    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", paddingBottom: "100px" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "#060606", boxShadow: "0 8px 32px rgba(0,0,0,0.3)",
          marginBottom: "16px",
        }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="https://kjpupnjfltltsdkrvnze.supabase.co/storage/v1/object/public/gallery/general/1778667913045-logo-rd-new.png"
            alt="Logo"
